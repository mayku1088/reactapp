...
const HotelReg = () => {
    ...
    const onSubmitHandler = async (e) => {
        try{
            ...
            const {data} = await axios.post(`/register-hotel`, {
  ...
  return (
    <div onClick={() => setShowHotelReg(false)} className="fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70">
        <form className="flex bg-white rounded-xl max-w-4xl max-md:mx-2" onSubmit={onSubmitHandler} onClick={(e) => e.stopPropagation()} >

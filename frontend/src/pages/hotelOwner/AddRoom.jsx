...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try{
      ...
      formData.append('price_per_night', inputs.pricePerNight);
      ...
      const {data} = await axios.post('/register-room', formData);
  ...
  return (
   <form onSubmit={onSubmitHandler}>
      <Title title="Add Room" subTitle="Fill the form man" align="left" font="outfit" />
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
          <div className="flex-1 max-w-48">
            ...
            <select value={inputs.roomType} onChange={(e) => setInputs({...inputs, roomType: e.target.value})} className="border opacity-70 border-gray-300 mt-1 rounded p-2 w-full" name="">
